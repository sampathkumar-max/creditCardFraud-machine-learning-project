...
class db_vali:
    ...
    def DBconnection(self, DatabaseName):
        try:
            ...
            self.log.log("log_msg//database_pre.txt", message)
    ...
    def insert_table_into_db(self,Databasename):
        try:
            ...
            for i in list_files:
                with open("prediction_raw_file//Good_data//"+i,"r")as f:
                    next(f,1)
    ...
    def Export_DB_csv(self,Databasename):
        try:
            ...
            csv_file=csv.writer(open("pre_FileFrom_DB//input.csv","w",newline=""),delimiter=",")
